...
/// Canonical request encoding and hashing for planner durable command receipts
/// (R-GEN-005).
///
...
/// different hash and is rejected by the command bus.
///
/// The hash is a 64-bit FNV-1a digest rendered as zero-padded hex — a
/// deduplication fingerprint, not a security primitive, so a fast non-crypto
/// hash keeps the production `lib` free of crypto dependencies. Each feature
/// owns its own canonical-request helper so infrastructure boundaries stay
/// independent.
abstract final class PlannerCanonicalRequest {
