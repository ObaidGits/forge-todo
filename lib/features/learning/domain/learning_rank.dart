/// A stable manual ordering rank for learning items (data-model §1 "stable
...
/// reordering never rewrites neighbours; the item id is the deterministic
/// tie-breaker. The learning feature keeps its own helper so feature
/// infrastructure boundaries stay independent (mirrors `PlanningRank`).
abstract final class LearningRank {
  ...
  /// Appends a new item after [last] (or the first rank when empty).
