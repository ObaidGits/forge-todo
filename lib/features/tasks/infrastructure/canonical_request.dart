...
/// Canonical request encoding and hashing for durable command receipts
/// (R-GEN-005).
///
...
///
/// The hash is a 64-bit FNV-1a digest rendered as zero-padded hex. It is a
/// deduplication fingerprint, not a security primitive, so a fast non-crypto
/// hash is appropriate (and keeps the production `lib` free of crypto deps).
abstract final class CanonicalRequest {
