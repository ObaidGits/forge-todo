...
/// Canonical request encoding and hashing for durable goal command receipts
/// (R-GEN-005).
///
...
/// production `lib` free of crypto dependencies.
abstract final class GoalCanonicalRequest {
