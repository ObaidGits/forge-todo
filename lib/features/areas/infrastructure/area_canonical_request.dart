...
/// Canonical request encoding and hashing for Life Area command receipts
/// (R-GEN-005).
///
...
/// deduplication fingerprint, not a security primitive, which keeps the
/// production `lib` free of crypto dependencies. Each feature owns its own
/// canonical-request helper so infrastructure boundaries stay independent.
abstract final class AreaCanonicalRequest {
