...
/// Canonical request encoding and hashing for durable fitness command receipts
/// (R-GEN-005).
///
...
/// different hash and is rejected by the command bus. The 64-bit FNV-1a digest
/// is a deduplication fingerprint, not a security primitive. Each feature owns
/// its own canonical-request helper so infrastructure boundaries stay
/// independent.
abstract final class FitnessCanonicalRequest {
